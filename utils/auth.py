...
def check_login():
    ...
    if b64:
        ...
        img_html = ('<div style="font-size:28px;color:' + RED +
                    ';font-weight:700">DOMA food</div>')

    st.markdown(
        '<div style="display:flex;justify-content:center;min-height:70vh;align-items:center">' +
        '<div style="background:#1A1A1A;border:1px solid #2D2D2D;border-radius:20px;' +
        'padding:48px 40px;max-width:400px;width:100%;text-align:center;border-top:4px solid ' + RED + '">' +
        img_html +
        '<div style="color:#B5B5BD;font-size:13px;margin-top:8px;margin-bottom:28px">' +
        'Dashboard iFood · Acesso restrito</div></div></div>',
